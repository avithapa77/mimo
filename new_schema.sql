...
INSERT IGNORE INTO users VALUES ('101430677889034962981', 'Hari Prasad');
...
INSERT IGNORE INTO gateways VALUES
    ...
    ('gw_kathmandu_home2','101430677889034962981',      'Kathmandu Home', 27.7172, 85.3240),
    ('gw_pokhara_house2', '101430677889034962981',      'Pokhara House',  28.2096, 83.9856);
...
INSERT IGNORE INTO devices VALUES
    ...
    ('dev_21', 'gw_kathmandu_home2', 'Living Room Light', 'light',      'on'),
    ('dev_22', 'gw_kathmandu_home2', 'Front Door Lock',   'lock',       'locked'),
    ('dev_23', 'gw_kathmandu_home2', 'AC Unit',           'thermostat', 'off'),
    ('dev_30', 'gw_pokhara_house2',  'Garden Light',      'light',      'off'),
    ('dev_31', 'gw_pokhara_house2',  'Main Gate',         'lock',       'locked');
